		...
		<div class="actions">
			...
			<ul>
				...
				<li>
					...
					(<a href="${base}/system/mail_settings/form">添加</a>)
				</li>
				 -->
				<li class="last">
			...
			<ul>
				<li>
					...
					(<a href="${base}/system/category/form?siteId=${param.siteId}">添加</a>)
				</li>
				<li>
					<a href="${base}/system/templates?siteId=${param.siteId}">模板管理</a>
					(<a href="${base}/system/template/form?siteId=${param.siteId}">添加</a>)
				</li>
				<li class="last">
					<a href="${base}/system/links?siteId=${param.siteId}">友情链接管理</a>
					(<a href="${base}/system/link/form?siteId=${param.siteId}">添加</a>)
				</li>
			</ul>
			<div>安全管理</div>
			<ul>
				...
				<li>
					...
					(<a href="${base}/system/role/form?siteId=${param.siteId}&categoryId=${param.categoryId}">添加</a>)
				</li>
				<li>
