...
public class BlogAspect {
	...
	@AfterReturning("execution(* org.osforce.e2.service.blog.BlogPostService.viewBlogPost(..))") 
	...
	@AfterReturning("execution(* org.osforce.e2.service.blog.BlogPostService.createBlogPost(..)) ||"
			+ "execution(* org.osforce.e2.service.blog.BlogPostService.updateBlogPost(..))") 
