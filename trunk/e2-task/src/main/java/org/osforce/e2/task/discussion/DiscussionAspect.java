...
public class DiscussionAspect {
	...
	@AfterReturning("execution(* org.osforce.e2.service.discussion.TopicService.viewTopic(..))")
	...
	@AfterReturning("execution(* org.osforce.e2.service.discussion.TopicService.createTopic(..)) ||" 
			+ "execution(* org.osforce.e2.service.discussion.TopicService.updateTopic(..))")
	...
	@AfterReturning("execution(* org.osforce.e2.service.discussion.ReplyService.createReply(..)) ||"
			+ "execution(* org.osforce.e2.service.discussion.ReplyService.updateReply(..))")
