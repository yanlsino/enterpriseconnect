...
public class ProfileAspect {
	...
	@AfterReturning("execution(* org.osforce.e2.service.profile.ProfileService.viewProfile(..))")
	...
	@AfterReturning("execution(* org.osforce.e2.service.profile.ProfileService.createProfile(..))"
			+ "execution(* org.osforce.e2.service.profile.ProfileService.updateProfile(..))")
