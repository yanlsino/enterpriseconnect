...
public class SystemAspect {
	...
	@AfterReturning("execution(* org.osforce.e2.service.system.ProjectService.createProject(..))")
	...
	@AfterReturning("execution(* org.osforce.e2.service.system.SiteService.backupSite(..))")
	...
	@AfterReturning("execution(* org.osforce.e2.service.system.SiteService.restoreSite(..))")
	...
	@AfterReturning("execution(* org.osforce.e2.service.system.ResourceService.syncResource(..))")
